...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__36832_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__36832_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__36832_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__36837){
var vec__36838 = p__36837;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36838,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36838,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__36841,s,color,element,idx){
var map__36842 = p__36841;
var map__36842__$1 = cljs.core.__destructure_map(map__36842);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36842__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36842__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36842__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__36845 = (function (){var or__4253__auto__ = color;
...
var fexpr__36844 = (function (){var G__36846 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__36846) : style_map.call(null,G__36846));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__36847){
var vec__36848 = p__36847;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36848,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36848,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36848,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__36853){
var vec__36854 = p__36853;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36854,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36854,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36854,(2),null);
...
var G__36980 = cljs.core.next(ssv);
var G__36981 = (this_ssv == null);
var G__36982 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__36983 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__36980;
doing_nil_QMARK_ = G__36981;
last_elide = G__36982;
out = G__36983;
continue;
}
...
var vec__36863 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36863,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36863,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36863,(2),null);
...
var G__36987 = cljs.core.next(remaining_cvec);
var G__36988 = new_idx;
var G__36989 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__36987;
idx = G__36988;
out = G__36989;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__36876,cursor_vec){
var vec__36877 = p__36876;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36877,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36877,(1),null);
var focus_vec = vec__36877;
...
var vec__36880 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36880,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36880,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__36883){
var vec__36884 = p__36883;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36884,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36884,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__36892,existing_count){
var vec__36893 = p__36892;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36893,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36893,(1),null);
...
return cljs.core.filterv((function (p1__36888_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__36888_SHARP_))));
...
var vec__36915 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36915,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36915,(1),null);
var cvec_element = vec__36915;
if((cvec_element == null)){
var G__37007 = cljs.core.next(cvec_nl);
var G__37008 = (idx + (1));
var G__37009 = start;
var G__37010 = out;
cvec_nl = G__37007;
...
var G__37017 = cljs.core.next(cvec_nl);
var G__37018 = (idx + (1));
var G__37019 = idx;
var G__37020 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37017;
idx = G__37018;
start = G__37019;
out = G__37020;
...
var G__37022 = cljs.core.next(cvec_nl);
var G__37023 = (idx + (1));
var G__37024 = (idx + (1));
var G__37025 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37022;
idx = G__37023;
start = G__37024;
out = G__37025;
...
var G__37027 = cljs.core.next(cvec_nl);
var G__37028 = (idx + (1));
var G__37029 = idx;
var G__37030 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37027;
idx = G__37028;
start = G__37029;
out = G__37030;
...
var G__37031 = cljs.core.next(cvec_nl);
var G__37032 = (idx + (1));
var G__37033 = start;
var G__37034 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37031;
idx = G__37032;
start = G__37033;
out = G__37034;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__36923_SHARP_,p2__36922_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__36922_SHARP_)){
return cljs.core.reduced(p1__36923_SHARP_);
} else {
return (p1__36923_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__36927,p__36928){
var vec__36930 = p__36927;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36930,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36930,(1),null);
var vec__36933 = p__36928;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36933,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36933,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__36960,cvec,focus_vec){
var map__36961 = p__36960;
var map__36961__$1 = cljs.core.__destructure_map(map__36961);
var options = map__36961__$1;
var map__36962 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36961__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__36962__$1 = cljs.core.__destructure_map(map__36962);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36962__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36962__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36962__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36954_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__36954_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
