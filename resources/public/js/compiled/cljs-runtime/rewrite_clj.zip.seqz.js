...
var G__38217 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__38217__$1 = (((G__38217 == null))?null:cljs.core.iterate((function (loc){
...
var G__38217__$2 = (((G__38217__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38217__$1));
var G__38217__$3 = (((G__38217__$2 == null))?null:cljs.core.last(G__38217__$2));
if((G__38217__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__38217__$3);
}
} else {
return zloc;
}
...
var G__38249 = rewrite_clj.zip.move.right(v);
var G__38250 = rewrite_clj.zip.move.up(v);
loc = G__38249;
parent = G__38250;
continue;
} else {
var G__38251 = rewrite_clj.zip.move.right(v0);
var G__38252 = parent;
loc = G__38251;
parent = G__38252;
continue;
...
var G__38255 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__38256 = rewrite_clj.zip.move.up(v);
loc = G__38255;
parent = G__38256;
continue;
} else {
var G__38257 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__38258 = parent;
loc = G__38257;
parent = G__38258;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__38226 = zloc;
var G__38226__$1 = (((G__38226 == null))?null:rewrite_clj.zip.move.down(G__38226));
var G__38226__$2 = (((G__38226__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__38226__$1,k));
if((G__38226__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__38226__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__38236 = rewrite_clj.zip.move.down(zloc);
var G__38236__$1 = (((G__38236 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__38236));
if((G__38236__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38236__$1);
}
})(),k);
}
});
