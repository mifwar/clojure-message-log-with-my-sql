...
message_log_3.views.display_messages = (function message_log_3$views$display_messages(p__49570){
var map__49571 = p__49570;
var map__49571__$1 = cljs.core.__destructure_map(map__49571);
var unix_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49571__$1,new cljs.core.Keyword(null,"unix-time","unix-time",-781363207));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49571__$1,new cljs.core.Keyword(null,"message","message",-406056002));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.input","input.input",-850828147),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(value),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__49572_SHARP_){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("message-log-3.events","update-db","message-log-3.events/update-db",704340530),id,p1__49572_SHARP_.target.value], null));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [message_log_3.views.text_input,new cljs.core.Keyword(null,"message","message",-406056002),"message"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [message_log_3.views.button_send,new cljs.core.Keyword(null,"message","message",-406056002),"submit"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button","button",1456579943),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("message-log-3.events","navigate","message-log-3.events/navigate",573682980),new cljs.core.Keyword(null,"about","about",1423892543)], null));
})], null),"go to About Page"], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2(message_log_3.views.display_messages,cljs.core.deref(messages))], null);
});
...
message_log_3.views.about_panel = (function message_log_3$views$about_panel(){
...
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("message-log-3.events","navigate","message-log-3.events/navigate",573682980),new cljs.core.Keyword(null,"home","home",-74557309)], null));
})], null),"go to Home Page"], null)], null)], null);
});
message_log_3.routes.panels.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Keyword(null,"about-panel","about-panel",334628515),(function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [message_log_3.views.about_panel], null);
}));
