...
var syms = (function (){var iter__4652__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__37350(s__37351){
return (new cljs.core.LazySeq(null,(function (){
var s__37351__$1 = s__37351;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__37351__$1);
if(temp__5753__auto__){
var s__37351__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37351__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__37351__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__37353 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__37352 = (0);
while(true){
if((i__37352 < size__4651__auto__)){
var i = cljs.core._nth(c__4650__auto__,i__37352);
...
cljs.core.chunk_append(b__37353,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__37413 = (i__37352 + (1));
i__37352 = G__37413;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37353),rewrite_clj$node$fn$fn_walk_$_iter__37350(cljs.core.chunk_rest(s__37351__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37353),null);
}
} else {
var i = cljs.core.first(s__37351__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__37350(cljs.core.rest(s__37351__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__37349_SHARP_){
var or__4253__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__37349_SHARP_);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return p1__37349_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k37368,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37368,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__37380){
var vec__37381 = p__37380;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37381,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37381,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37367){
var self__ = this;
var G__37367__$1 = this;
return (new cljs.core.RecordIter((0),G__37367__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37369,other37370){
var self__ = this;
var this37369__$1 = this;
return (((!((other37370 == null)))) && ((((this37369__$1.constructor === other37370.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37369__$1.children,other37370.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37369__$1.__extmap,other37370.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k37368){
var self__ = this;
var this__4509__auto____$1 = this;
var G__37389 = k37368;
var G__37389__$1 = (((G__37389 instanceof cljs.core.Keyword))?G__37389.fqn:null);
switch (G__37389__$1) {
case "children":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37368);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__37367){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__37390 = cljs.core.keyword_identical_QMARK_;
var expr__37391 = k__4511__auto__;
if(cljs.core.truth_((pred__37390.cljs$core$IFn$_invoke$arity$2 ? pred__37390.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37391) : pred__37390.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37391)))){
return (new rewrite_clj.node.fn.FnNode(G__37367,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__37367),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__37367){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__37367,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__37372){
var extmap__4542__auto__ = (function (){var G__37394 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__37372,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37372),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
