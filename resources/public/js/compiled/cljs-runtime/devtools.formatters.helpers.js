...
var G__27783 = devtools.prefs.pref(v);
v = G__27783;
continue;
} else {
return v;
...
}catch (e27710){var _e__27108__auto__ = e27710;
return false;
}})();
...
}catch (e27712){var _e__27108__auto__ = e27712;
return false;
}})();
...
}catch (e27714){var _e__27108__auto__ = e27714;
return false;
}}
}
});
...
var vec__27727 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27727,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27727,(1),null);
...
return cljs.core.some((function (p1__27741_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27741_SHARP_);
}),template);
});
