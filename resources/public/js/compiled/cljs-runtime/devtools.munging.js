...
var o27426 = temp__5751__auto__;
var temp__5751__auto____$1 = (o27426["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27427 = temp__5751__auto____$1;
return (o27427["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27100__auto__ = f;
return (o__27100__auto__["toString"]).call(o__27100__auto__);
} else {
return "";
}
}catch (e27428){var _ = e27428;
return "";
}});
...
try{var o__27100__auto___27670 = t;
(o__27100__auto___27670["cljs$lang$ctorPrWriter"]).call(o__27100__auto___27670,t,writer);
}catch (e27431){var __27674 = e27431;
}
...
var char_code = (function (){var o__27100__auto__ = (new String(char$));
return (o__27100__auto__["charCodeAt"]).call(o__27100__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27100__auto__ = String;
return (o__27100__auto__["fromCharCode"]).call(o__27100__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27440 = num_code;
switch (G__27440) {
case (1):
return (185);
...
var o__27100__auto__ = String;
return (o__27100__auto__["fromCharCode"]).call(o__27100__auto__,superscript_code);
});
/**
...
}catch (e27453){var _e__27108__auto__ = e27453;
return false;
}})())){
...
var vec__27455 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27455,(0),null);
...
var G__27691 = (i__4865__auto___27688 + (1));
i__4865__auto___27688 = G__27691;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27470){
var vec__27471 = p__27470;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27471,(0),null);
...
var G__27692 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27693 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27692;
remaining_tokens = G__27693;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27468){
var G__27469 = cljs.core.first(seq27468);
var seq27468__$1 = cljs.core.next(seq27468);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27469,seq27468__$1);
}));
...
var vec__27479 = cljs.core.split_with((function (p1__27477_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27477_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27479,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27479,(1),null);
...
var vec__27486 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27486,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27486,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27696 = cljs.core.rest(remaining_tokens);
var G__27698 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27696;
name_tokens = G__27698;
continue;
} else {
...
var vec__27504 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27504,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27504,(1),null);
var vec__27507 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27507,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27507,(1),null);
var vec__27510 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27510,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27510,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27510,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27510,(3),null);
...
var vec__27520 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27520,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27523 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27523,(1),null);
var vec__27526 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27526,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27526,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27531 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27531) : devtools.munging.parse_fn_info_deep.call(null,G__27531));
})()));
}
} else {
return fn_info;
...
var G__27723 = (arity + (1));
var G__27724 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27543){
var vec__27544 = p__27543;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27544,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27544,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27557_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27557_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27558_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27558_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___27735 = arguments.length;
var i__4865__auto___27736 = (0);
while(true){
if((i__4865__auto___27736 < len__4864__auto___27735)){
args__4870__auto__.push((arguments[i__4865__auto___27736]));

var G__27737 = (i__4865__auto___27736 + (1));
i__4865__auto___27736 = G__27737;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27576){
var vec__27577 = p__27576;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27577,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27571){
var G__27572 = cljs.core.first(seq27571);
var seq27571__$1 = cljs.core.next(seq27571);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27572,seq27571__$1);
}));
...
var map__27604 = options;
var map__27604__$1 = cljs.core.__destructure_map(map__27604);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27604__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27604__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27604__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27604__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27605 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27605,(5),null);
...
var o__27100__auto__ = f;
return (o__27100__auto__["getBasis"]).call(o__27100__auto__);
});
/**
...
}catch (e27619){var _e__27108__auto__ = e27619;
...
var G__27769 = (obj[cljs.core.first(path)]);
var G__27770 = cljs.core.rest(path);
obj = G__27769;
path = G__27770;
continue;
} else {
...
var _STAR_ = (function (accum,p__27631){
var vec__27632 = p__27631;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27632,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27635){
var vec__27636 = p__27635;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27636,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27636,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27636,(2),null);
...
var post_process = (function (p__27644){
var vec__27645 = p__27644;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27645,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27645,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27640_SHARP_){
return (obj[cljs.core.first(p1__27640_SHARP_)]);
}),sorted_matches);
