...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__37737 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__37737) : f.call(null,G__37737));
})(),sq);
});
...
var comma_37785 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_37786 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__37760){
var vec__37761 = p__37760;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37761,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37761,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_37786,rewrite_clj.node.protocols.coerce(v),comma_37785], null);
