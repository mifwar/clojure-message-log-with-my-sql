...
var G__39062 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__39062;
continue;
} else {
var G__39063 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39063;
continue;
}
} else {
var G__39064 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39064;
continue;
}
}
...
var G__39051 = zloc;
var G__39052 = (function (){var G__39053 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__39054 = zloc;
var G__39054__$1 = (((G__39054 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__39054) : rewrite_clj.zip.node.call(null,G__39054)));
if((G__39054__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39054__$1) : zprint.zutil.edn_STAR_.call(null,G__39054__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__39053) : rewrite_clj.zip.root.call(null,G__39053));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__39051,G__39052) : rewrite_clj.zip.replace.call(null,G__39051,G__39052));
});
/**
...
var G__39066 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__39066;
continue;
}
break;
...
var G__39067 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__39068 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__39067;
out = G__39068;
continue;
} else {
...
var G__39069 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__39070 = cljs.core.next(new_loc);
var G__39071 = replaced_loc;
nloc = G__39069;
new_loc = G__39070;
last_loc = G__39071;
continue;
...
return zprint.rewrite.sort_val((function (){var G__39055 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__39055) : rewrite_clj.zip.down.call(null,G__39055));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__39056_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__39056_SHARP_) : rewrite_clj.zip.tag.call(null,p1__39056_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__39056_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__39056_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
