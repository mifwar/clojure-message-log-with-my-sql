...
var G__34447 = o;
reagent.impl.template.goog$module$goog$object.set(G__34447,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34532__delegate = function (args){
...
return G__34532__delegate.call(this,args);};
...
return G__34532__delegate(args);
});
...
var G__34450 = o;
reagent.impl.template.goog$module$goog$object.set(G__34450,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34535__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34536__i < G__34536__a.length) {G__34536__a[G__34536__i] = arguments[G__34536__i + 0]; ++G__34536__i;}
  args = new cljs.core.IndexedSeq(G__34536__a,0,null);
} 
return G__34535__delegate.call(this,args);};
G__34535.cljs$lang$maxFixedArity = 0;
G__34535.cljs$lang$applyTo = (function (arglist__34537){
var args = cljs.core.seq(arglist__34537);
return G__34535__delegate(args);
});
...
var G__34458 = props;
var G__34458__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34458,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34458);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34458__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34463 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34463,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34463;
}
})(),id_class);
...
var G__34466 = (cljs.core.count(argv) - first_child);
switch (G__34466) {
case (0):
...
var vec__34478 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34478,(2),null);
...
var temp__5757__auto___34540 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34540 == null)){
} else {
var key_34541 = temp__5757__auto___34540;
(jsprops.key = key_34541);
}
...
var temp__5757__auto___34542 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34542 == null)){
} else {
var key_34543 = temp__5757__auto___34542;
(jsprops.key = key_34543);
}
...
var temp__5757__auto___34544 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___34544 == null)){
} else {
var key_34545 = temp__5757__auto___34544;
(jsprops.key = key_34545);
}
...
var temp__5757__auto___34546 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34546 == null)){
} else {
var key_34547 = temp__5757__auto___34546;
(jsprops.key = key_34547);
}
...
var temp__5757__auto___34548 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34548 == null)){
} else {
var key_34549 = temp__5757__auto___34548;
(jsprops.key = key_34549);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34482_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__34482_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__34485 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34485,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34485,(1),null);
...
break;
default:
var G__34551 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template34517 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template34517 = (function (opts,id,fn_to_element,parse_fn,meta34518){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34517.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34519,meta34518__$1){
var self__ = this;
var _34519__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34517(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta34518__$1));
}));

(reagent.impl.template.t_reagent$impl$template34517.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34519){
var self__ = this;
var _34519__$1 = this;
return self__.meta34518;
}));

(reagent.impl.template.t_reagent$impl$template34517.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34517.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34517.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template34517.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34517.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34517.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta34518","meta34518",1390969303,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34517.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34517.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34517");

(reagent.impl.template.t_reagent$impl$template34517.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template34517");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34517.
 */
reagent.impl.template.__GT_t_reagent$impl$template34517 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template34517(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34518){
return (new reagent.impl.template.t_reagent$impl$template34517(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34518));
});

}

return (new reagent.impl.template.t_reagent$impl$template34517(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
