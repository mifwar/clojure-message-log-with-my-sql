...
var G__31565 = request;
var G__31566 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__31565,G__31566) : ajax.formats.get_format.call(null,G__31565,G__31566));
} else {
...
return cljs.core.some((function (p1__31573_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__31573_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__31575){
var map__31576 = p__31575;
var map__31576__$1 = cljs.core.__destructure_map(map__31576);
var request = map__31576__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31576__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__31582 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__31582.cljs$core$IFn$_invoke$arity$1 ? fexpr__31582.cljs$core$IFn$_invoke$arity$1(response) : fexpr__31582.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__31584){
var map__31585 = p__31584;
var map__31585__$1 = cljs.core.__destructure_map(map__31585);
var request = map__31585__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31585__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__31583_SHARP_){
return ajax.formats.get_accept_entries(request,p1__31583_SHARP_);
