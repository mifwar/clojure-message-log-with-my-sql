...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31348 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_31348(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_31349 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_31349(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_31350 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_31350(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_31351 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_31351(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_31352 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_31352(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_31353 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_31353(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_31354 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_31354(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_31355 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_31355(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_31356 = (function (this$,request){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_31356(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_31361 = (function (this$,response){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_31361(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k31334,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k31334,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__31339){
var vec__31340 = p__31339;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31340,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31340,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__31333){
var self__ = this;
var G__31333__$1 = this;
return (new cljs.core.RecordIter((0),G__31333__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this31335,other31336){
var self__ = this;
var this31335__$1 = this;
return (((!((other31336 == null)))) && ((((this31335__$1.constructor === other31336.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.status,other31336.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.body,other31336.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.status_text,other31336.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.headers,other31336.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.was_aborted,other31336.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this31335__$1.__extmap,other31336.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k31334){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k31334);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__31333){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__31344 = cljs.core.keyword_identical_QMARK_;
var expr__31345 = k__4511__auto__;
if(cljs.core.truth_((pred__31344.cljs$core$IFn$_invoke$arity$2 ? pred__31344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__31345) : pred__31344.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__31345)))){
return (new ajax.protocols.Response(G__31333,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31344.cljs$core$IFn$_invoke$arity$2 ? pred__31344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__31345) : pred__31344.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__31345)))){
return (new ajax.protocols.Response(self__.status,G__31333,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31344.cljs$core$IFn$_invoke$arity$2 ? pred__31344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31345) : pred__31344.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__31345)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__31333,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31344.cljs$core$IFn$_invoke$arity$2 ? pred__31344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31345) : pred__31344.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__31345)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__31333,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__31344.cljs$core$IFn$_invoke$arity$2 ? pred__31344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31345) : pred__31344.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__31345)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__31333,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__31333),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__31333){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__31333,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__31337){
var extmap__4542__auto__ = (function (){var G__31347 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__31337,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__31337)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__31347);
} else {
return G__31347;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__31337),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__31337),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__31337),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__31337),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__31337),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
