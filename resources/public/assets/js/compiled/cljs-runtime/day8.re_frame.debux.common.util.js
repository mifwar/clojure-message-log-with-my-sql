...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__47911){
var vec__47912 = p__47911;
...
return clojure.zip.zipper((function (p1__47920_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__47920_SHARP_)) || (cljs.core.map_QMARK_(p1__47920_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__47926){
var vec__47927 = p__47926;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47927,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47927,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47946_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__47946_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47943_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__47943_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47952_SHARP_){
return (((p1__47952_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__47952_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__47955,mapping){
var map__47956 = p__47955;
var map__47956__$1 = cljs.core.__destructure_map(map__47956);
var state = map__47956__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47956__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47956__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47956__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47954_SHARP_){
var and__4251__auto__ = (p1__47954_SHARP_ instanceof cljs.core.Symbol);
if(and__4251__auto__){
return cljs.core.namespace(p1__47954_SHARP_);
} else {
...
var G__48158 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__48163 = clojure.zip.next(loc);
loc = G__48163;
continue;
}
}
...
var len__4864__auto___48186 = arguments.length;
var i__4865__auto___48187 = (0);
while(true){
if((i__4865__auto___48187 < len__4864__auto___48186)){
args__4870__auto__.push((arguments[i__4865__auto___48187]));

var G__48188 = (i__4865__auto___48187 + (1));
i__4865__auto___48187 = G__48188;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__48031){
var vec__48032 = p__48031;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48032,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq48019){
var G__48020 = cljs.core.first(seq48019);
var seq48019__$1 = cljs.core.next(seq48019);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48020,seq48019__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48038_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48038_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__48040_48191 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__48041_48192 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__48042_48193 = true;
var _STAR_print_fn_STAR__temp_val__48043_48194 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__48042_48193);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__48043_48194);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__48041_48192);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__48040_48191);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4795__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48039_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__48039_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__48195 = cljs.core.next(opts__$1);
var G__48196 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__48195;
acc = G__48196;
continue;
} else {
if(typeof f === 'string'){
var G__48199 = cljs.core.next(opts__$1);
var G__48200 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__48199;
acc = G__48200;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__48201 = cljs.core.nnext(opts__$1);
var G__48202 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__48201;
acc = G__48202;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__48205 = cljs.core.next(opts__$1);
var G__48207 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__48205;
acc = G__48207;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48064 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__48064.cljs$core$IFn$_invoke$arity$1 ? fexpr__48064.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48064.call(null,f));
})())){
var G__48216 = cljs.core.next(opts__$1);
var G__48217 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__48216;
acc = G__48217;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48066 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__48066.cljs$core$IFn$_invoke$arity$1 ? fexpr__48066.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48066.call(null,f));
})())){
var G__48224 = cljs.core.nnext(opts__$1);
var G__48225 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__48224;
acc = G__48225;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__48232 = cljs.core.next(opts__$1);
var G__48233 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__48232;
acc = G__48233;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__48084){
...
var G__48099 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__48098 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48119 = quoted_form;
var G__48120 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48119,G__48120) : day8.re_frame.debux.common.util.remove_d.call(null,G__48119,G__48120));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48122 = quoted_form;
var G__48123 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48122,G__48123) : day8.re_frame.debux.common.util.remove_d.call(null,G__48122,G__48123));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__48250__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48128 = quoted_form;
var G__48129 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48128,G__48129) : day8.re_frame.debux.common.util.remove_d.call(null,G__48128,G__48129));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__48260__i < G__48260__a.length) {G__48260__a[G__48260__i] = arguments[G__48260__i + 0]; ++G__48260__i;}
  arg = new cljs.core.IndexedSeq(G__48260__a,0,null);
} 
return G__48250__delegate.call(this,arg);};
G__48250.cljs$lang$maxFixedArity = 0;
G__48250.cljs$lang$applyTo = (function (arglist__48261){
var arg = cljs.core.seq(arglist__48261);
return G__48250__delegate(arg);
});
...
var G__48266 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48266;
continue;
} else {
...
var G__48268 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48268;
continue;
} else {
var G__48269 = clojure.zip.next(loc);
loc = G__48269;
continue;
