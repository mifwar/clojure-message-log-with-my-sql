...
if((c === "\n")){
var G__37812 = escape_QMARK_;
var G__37813 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__37812;
lines = G__37813;
continue;
} else {
buf.append(c);

var G__37814 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__37815 = lines;
escape_QMARK_ = G__37814;
lines = G__37815;
continue;
...
var G__37807 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__37807) : rewrite_clj.node.string_node.call(null,G__37807));
});
...
var G__37808 = cljs.core.re_pattern(regex);
var G__37809 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__37808,G__37809) : rewrite_clj.node.token_node.call(null,G__37808,G__37809));
});
