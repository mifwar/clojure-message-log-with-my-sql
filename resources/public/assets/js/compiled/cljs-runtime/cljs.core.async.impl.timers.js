...
var i_42844 = (0);
while(true){
if((i_42844 < arr.length)){
(arr[i_42844] = null);

var G__42847 = (i_42844 + (1));
i_42844 = G__42847;
continue;
} else {
}
...
var i_42855 = (self__.level + (1));
while(true){
if((i_42855 <= (new_level + (1)))){
(update[i_42855] = self__.header);

var G__42856 = (i_42855 + (1));
i_42855 = G__42856;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_42857 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_42857[i]));
} else {
x__$2.forward.push((((i < links_42857.length))?(links_42857[i]):null));
}

if((i < links_42857.length)){
(links_42857[i] = x__$2);
} else {
links_42857.push(x__$2);
}
...
var i_42859 = (0);
while(true){
if((i_42859 <= self__.level)){
var links_42860 = (update[i_42859]).forward;
if((x__$1 === (((i_42859 < links_42860.length))?(links_42860[i_42859]):null))){
(links_42860[i_42859] = (x__$1.forward[i_42859]));

var G__42861 = (i_42859 + (1));
i_42859 = G__42861;
continue;
} else {
var G__42862 = (i_42859 + (1));
i_42859 = G__42862;
continue;
}
} else {
...
var G__42864 = nx;
var G__42865 = (level__$1 - (1));
x = G__42864;
level__$1 = G__42865;
continue;
} else {
var G__42866 = x;
var G__42867 = (level__$1 - (1));
x = G__42866;
level__$1 = G__42867;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__42869 = nx;
var G__42870 = (level__$1 - (1));
x = G__42869;
level__$1 = G__42870;
continue;
} else {
var G__42871 = x;
var G__42872 = (level__$1 - (1));
x = G__42871;
level__$1 = G__42872;
continue;
}
